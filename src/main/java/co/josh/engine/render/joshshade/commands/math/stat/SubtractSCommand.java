...
public class SubtractSCommand implements JShaderCommand {
    ...
    public void setArgs(ArrayList<Object> args) {
        ...
        if (index == null) {
            throw new JoshShaderFailure("SubtractStatic: No insert index found!");
        }
        value = findValue(args, skipindex);
        if (value == null) {
            throw new JoshShaderFailure("SubtractStatic: No value to insert!");
        }
    }
        ...
        for (Object o : args) {
            if (o instanceof Integer) {
                ...
                try {
                    ...
                    System.out.println("(SubtractStatic) Warning: " + o + " is not a number!");
                }
            }
            i++;
        }
