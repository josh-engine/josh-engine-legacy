...
public class DivideSCommand implements JShaderCommand {
    ...
    public void setArgs(ArrayList<Object> args) {
        ...
        if (index == null) {
            throw new JoshShaderFailure("DivideStatic: No insert index found!");
        }
        value = findValue(args, skipindex);
        if (value == null) {
            throw new JoshShaderFailure("DivideStatic: No value to insert!");
        }
    }
        ...
        for (Object o : args) {
            if (o instanceof Integer) {
                ...
                try {
                    ...
                    System.out.println("(DivideStatic) Warning: " + o + " is not a number!");
                }
            }
            i++;
        }
