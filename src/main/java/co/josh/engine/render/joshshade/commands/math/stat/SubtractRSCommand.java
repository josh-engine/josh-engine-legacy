...
public class SubtractRSCommand implements JShaderCommand {
    ...
    public void setArgs(ArrayList<Object> args) {
        ...
        if (index == null) {
            throw new JoshShaderFailure("SubtractReverseStatic: No insert index found!");
        }
        value = findValue(args, skipindex);
        if (value == null) {
            throw new JoshShaderFailure("SubtractReverseStatic: No value to insert!");
        }
    }
        ...
        for (Object o : args) {
            if (o instanceof Integer) {
                ...
                try {
                    ...
                    System.out.println("(SubtractReverseStatic) Warning: " + o + " is not a number!");
                }
            }
            i++;
        }
    ...
    public ArrayList<Object> run() {
        if (input.get(index) instanceof Number){
            ...
            input.set(index, value-a);
        }
        return input;
    }

    public String functionName() {
        return "staticrsubtract";
    }
}
